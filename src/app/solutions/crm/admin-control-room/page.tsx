...
function PageSection({ children }: { children: React.ReactNode }) {
    return <section className="min-w-0 flex-1 bg-white"><div className="mx-auto max-w-[min(92vw,1440px)] px-5 py-10 sm:px-6 lg:px-8 xl:px-10 2xl:px-12">{children}</div></section>;
}
