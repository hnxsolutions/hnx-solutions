...
export default function ServicesPage() {
  ...
  return (
    <main className="w-full max-w-full overflow-x-hidden bg-(--bg) text-(--text)">
      {/* Hero Section */}
      <section className="hero-light relative isolate flex min-h-[88vh] items-center overflow-hidden pt-32 pb-20 sm:pt-36">
        <div className="absolute inset-0 z-0 h-full w-full">
          ...
          <div
            aria-hidden
            className="absolute right-[3%] top-1/2 hidden w-[50rem] max-w-[60vw] -translate-y-1/2 opacity-10 blur-[0.2px] lg:block dark:opacity-20"
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="relative z-10 max-w-3xl text-center lg:text-left">
            ...
            <motion.h1
              ...
              className="mb-6 max-w-4xl text-4xl font-extrabold leading-[0.95] tracking-tight text-(--text) md:text-6xl lg:text-7xl"
            ...
            <motion.p
              ...
              className="mb-8 max-w-2xl text-lg leading-relaxed text-(--text-muted) md:text-xl lg:mx-0"
            >
            ...
            {services.map((service, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="glass-card group relative overflow-hidden rounded-3xl border border-(--border) p-7 shadow-xl transition-all duration-500 hover:border-cyan-300/20 hover:shadow-2xl hover:shadow-accent/20 md:p-8"
                >
                  ...
                  <div className="relative z-10">
                    <div className="mb-5 flex items-center justify-between gap-4">
                      <span className="inline-flex h-14 w-14 items-center justify-center rounded-2xl border border-(--border) bg-white/35 dark:bg-white/[0.04]">
                        {icons[i]}
                      </span>
                    ...
                    <p className="mb-5 min-h-[84px] text-sm leading-7 text-(--text-muted) md:text-base">
                    ...
                    <div className="mb-6 flex flex-wrap gap-2">
                      {service.tags.slice(0, 4).map((tag) => (
                        <span
                          key={tag}
                          className="rounded-full border border-(--border) bg-white/45 px-3 py-1 text-xs text-(--text-muted) dark:bg-white/5 dark:text-(--text-muted)"
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    <div className="mb-6 rounded-2xl border border-(--border) bg-white/40 px-4 py-3 dark:bg-white/[0.03]">
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row">
                      ...
                      <Link
                        href="/contact"
                        className="inline-flex w-full items-center justify-center rounded-xl border border-(--border) bg-white/35 px-5 py-3 text-sm font-semibold text-(--text) transition-all duration-300 hover:border-cyan-300/30 hover:bg-white/60 dark:bg-white/[0.03]"
                      >
                        Get Quote
                      </Link>
                    </div>
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center lg:px-8">
          ...
          >
            ...
            <div className="flex flex-col justify-center gap-4 sm:flex-row">
              ...
              <Link
                href="#services-grid"
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-(--border) bg-white/40 px-8 py-4 text-lg font-semibold text-(--text) transition-all hover:bg-white/60 hover:border-primary/30 dark:bg-white/[0.03]"
              >
                Browse Services
              </Link>
            </div>
