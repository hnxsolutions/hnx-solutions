...
export const services: ServiceItem[] = [
  ...
  },
  {
    ...
    shortDescription:
      "Owned CRM systems with workflow automation, AI insights, dashboards, and secure business roles.",
    fullDescription:
      "HNX builds custom CRM systems around your business process instead of forcing your team into a generic subscription tool. We create CRM cores, dashboards, workflow engines, AI intelligence layers, reporting, integrations, and secure role-based controls for growing operations.",
    startingPrice: "Starting from $500",
    timeline: "4 to 8 weeks",
    bestFor:
      "Sales teams, lead tracking, pipeline management, customer operations, workflow automation, and owned business systems.",
    tags: [
      "Custom CRM",
      "Workflow Automation",
      "AI Insights",
    ...
    details: [
      "Custom CRM modules for leads, deals, customers, tasks, reports, and operations",
      "Workflow engine for reminders, assignments, approvals, escalations, and follow-ups",
      "AI intelligence layer for summaries, smart insights, prioritization, and recommendations",
      "Secure roles and permissions for admins, managers, teams, and field users",
      "Integrations with websites, forms, messaging, payments, documents, and reporting systems",
    ],
    packages: [
      {
        name: "CRM Starter",
        price: "$500 - $900",
        description:
          "For businesses that need a clean owned CRM foundation for leads, customers, and tasks.",
        features: [
      ...
      },
      {
        ...
        price: "$900 - $1,800",
        description:
          "For teams that need automation, stronger dashboards, and controlled business workflows.",
        features: [
          "Custom modules",
          "Workflow automation",
          "Realtime dashboards",
      ...
      {
        name: "Advanced HNX CRM System",
        price: "$1,800+",
        description:
          "For complex operations that need AI insights, advanced automation, and industry modules.",
        features: [
          "AI intelligence layer",
          "Advanced workflow engine",
          "Industry CRM modules",
          "Custom reporting",
