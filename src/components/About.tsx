    ...
    <main className="page-shell relative">
      <section className="page-hero hero-light relative isolate min-h-[78svh] md:min-h-[88vh] lg:flex lg:items-center">
        ...
        <div className="relative z-10 mx-auto w-full max-w-[min(92vw,1440px)] px-5 sm:px-6 lg:px-8 xl:px-10 2xl:px-12">
          <div className="grid items-center gap-10 md:gap-14 lg:grid-cols-[1.1fr_0.9fr]">
            <motion.div
            ...
            >
              ...
              >
                ...
                <Link
                  href="/contact"
                  className="gradient-border inline-flex items-center justify-center gap-2 rounded-xl border border-(--border) bg-white/55 px-6 py-4 text-base font-semibold text-(--text) transition-all hover:border-primary/30 hover:bg-white/80 dark:bg-white/4"
                >
                  Let’s Work Together
                </Link>
              </motion.div>
        ...
        <div className="relative mx-auto max-w-[min(92vw,1440px)] px-5 sm:px-6 lg:px-8 xl:px-10 2xl:px-12">
          <div className="grid items-start gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:gap-12">
            <motion.div
              ...
              className="glass-card depth-card rounded-4xl p-6 md:p-8 lg:p-10"
            >
      ...
      <section className="section-shell relative overflow-hidden grid-bg">
