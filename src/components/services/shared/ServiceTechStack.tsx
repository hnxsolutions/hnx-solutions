...
export default function ServiceTechStack({ service }: ServiceTechStackProps) {
  ...
  return (
    <section className="relative px-5 py-14 sm:px-6 lg:px-8 xl:px-10 2xl:px-12">
      <div className="relative mx-auto w-full max-w-[min(92vw,1440px)] overflow-hidden rounded-[2.4rem] border border-white/70 bg-slate-950 p-6 text-white shadow-[0_30px_100px_rgba(15,23,42,0.18)] dark:border-white/10 dark:bg-[#070a12] dark:shadow-[0_30px_100px_rgba(0,0,0,0.34)] sm:p-8 lg:p-10">
          ...
          <div>
            ...
            <div className="mt-7 rounded-[1.6rem] border border-white/10 bg-white/8 p-5 backdrop-blur-xl dark:bg-white/7">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-black uppercase tracking-[0.18em] text-white/50">Stack strategy</p>
            ...
            {stack.tools.map((tool, index) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -8, rotateX: 4, rotateY: index % 2 === 0 ? -4 : 4, scale: 1.03 }}
                ...
                >
                  ...
                  <span className={`relative grid h-11 w-11 place-items-center rounded-2xl bg-gradient-to-br ${service.accent} text-white shadow-[0_14px_34px_rgba(0,0,0,0.18)]`} style={{ transform: "translateZ(18px)" }}>
                    <Icon className="h-5 w-5" aria-hidden="true" />
                  </span>
                  <p className="relative mt-4 min-h-10 text-sm font-black leading-5 text-white">{tool.name}</p>
